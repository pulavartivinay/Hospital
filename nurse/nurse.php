...
<html>
    <body>
        <h1>Hospital</h1>
        <form method="post">
            <input type="submit" name="addNurse"
                    class="button" value="add Nurse" />
            <input type="submit" name="showNurse"
                    class="button" value="show Nurse" />
            <input type="submit" name="editNurse"
                    class="button" value="edit Nurse" />
            <input type="submit" name="deleteNurse"
                    class="button" value="delete Nurse" />
        </form>
        <?php
            echo '<body style="background-color:#383A59; color:white">';
            if(array_key_exists('addNurse', $_POST)) {
                addPatient();
            }
            else if(array_key_exists('showNurse', $_POST)) {
                showPatient();
            }
            else if(array_key_exists('editNurse', $_POST)) {
                editPatient();
            }
            else if(array_key_exists('deleteNurse', $_POST)) {
                deletePatient();
            }
            function addPatient() {
